...
# Multiplayer events
signal mp_player_connected(peer_id)
signal mp_player_disconnected(peer_id)
signal mp_connected_to_server()
signal mp_connection_failed()
signal mp_server_disconnected()
signal mp_server_info_received(info)
signal mp_registration_rejected(reason)
signal mp_player_list_updated(player_list)
signal mp_game_starting(settings)
signal mp_turn_started(turn)
signal mp_turn_status_updated(ended_players)
signal mp_turn_timer_updated(remaining)
signal mp_action_rejected(action, reason)
signal mp_reconnected(player_id, turn)
